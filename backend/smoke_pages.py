...
PAGES = [
    ...
    "/admin/finance/add", "/admin/finance/add?txn_type=income", "/admin/finance/stats", "/admin/finance/charts",
    "/admin/finance/accounts", "/admin/finance/more", "/admin/finance/trash",
    "/admin/finance/categories", "/admin/finance/plan", "/admin/finance/recurring", "/admin/finance/ai",
    "/admin/ai", "/admin/ai/providers", "/admin/ai/logs",
